...
Conversions from Ligo types to Michelsontypes require a precise knowledge of data structures representation.
...
```
type Michelsonis michelson_pair_left_comb(l_record)
...
function to_michelson (const f: l_record) : Michelsonis
  block {
