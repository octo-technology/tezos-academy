...
<!-- prettier-ignore -->The expected parameter *permissions\_descriptor\_params* for this entry point is a callback function sending back a *permissions\_descriptor* to calling contract. Those calling contract are considered as "Fa2 client contract".
