...
describe('User', () => {
  ...
  it('registration can send email', async (done) => {
    ...
    const emailMsg = {
      ...
      html:
        'Please enter the following captcha <br /><img alt="captcha" src="https://b2.tezosacademy.io/file/tezosacademy/captchas/0.png" /> <br />on <a href="https://tezosacademy.io/reset-password?key=test">https://tezosacademy.io/reset-password?key=test</a>',
      subject: 'Password reset',
      text:
        'Please enter the following captcha https://b2.tezosacademy.io/file/tezosacademy/captchas/0.png on https://tezosacademy.io/reset-password?key=test',
