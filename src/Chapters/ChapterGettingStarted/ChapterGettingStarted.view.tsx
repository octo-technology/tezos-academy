...
//prettier-ignore
import { ChapterContent, ChapterValidatorContentWrapper,ChapterCourse, ButtonBorder, ButtonText, ChapterValidatorInside, ChapterGettingStartedGrid, ChapterGettingStartedStyled, ChapterH1, ChapterH2, ChapterValidator, ChapterValidatorTitle, ChapterValidatorContent, Button } from "./ChapterGettingStarted.style";
import { text1, code1, text2, code2 } from "./ChapterGettingStarted.data";
...
export const ChapterGettingStartedView = () => {
  return (
    <ChapterGettingStartedStyled>
      <ChapterCourse>
        <ChapterH1>Chapter 1 : Getting started</ChapterH1>
